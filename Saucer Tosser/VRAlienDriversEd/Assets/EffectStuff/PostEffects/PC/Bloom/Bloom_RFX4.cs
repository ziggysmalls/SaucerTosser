...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class Bloom_RFX4 : MonoBehaviour
    {
        ...
        public struct Settings
        {
            ...
            [MinAttribute_RFX4(0f), Tooltip("Amount of lens dirtiness.")]
        ...
        public Shader shader
        {
            get
            {
                if (m_Shader == null)
                {
                    const string shaderName = "Hidden/Image Effects/Cinematic/Bloom_RFX4";
        ...
        {
            if (!ImageEffectHelper_RFX4.IsSupported(shader, true, false, this))
                enabled = false;
        }
